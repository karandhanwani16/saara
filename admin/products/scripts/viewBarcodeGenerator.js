...
async function generateBarcodeMain(id) {

    const productData = await getProductDetails(id);

    const { barcode } = productData;
    openPopup(productData);
    loadScript("https://cdn.jsdelivr.net/npm/jsbarcode@3.11.0/dist/barcodes/JsBarcode.code128.min.js", () => {
        generateBarcode(barcode);
    });
}

function generateBarcode(generatedNumber) {
