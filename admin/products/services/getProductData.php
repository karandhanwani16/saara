...
if (isset($_POST["search"]["value"])) {
    ...
    $query .= ' where p.product_id like "%' . $_POST["search"]["value"] . '%" or p.product_name like "%' . $_POST["search"]["value"] . '%" or c.category_name like "%' . $_POST["search"]["value"] . '%" or b.brand_name like "%' . $_POST["search"]["value"] . '%" or p.product_barcode like "%' . $_POST["search"]["value"] . '%" or p.product_description like "%' . $_POST["search"]["value"] . '%" or p.product_created_by like "%' . $_POST["search"]["value"] . '%" or p.product_updated_by like "%' . $_POST["search"]["value"] . '%"';
}
