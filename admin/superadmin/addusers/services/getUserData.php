...
while ($row = $result->fetch_assoc()) {
    ...
    $sub_array[] = "<a href='singleUser.php?id=" . $row['user_id'] . "' class='select-btn'>Select</a>";
    $sub_array[] = "<div class='btn delete-btn' data-id='" . $row["user_id"] . "'>Delete</div>";
    $sub_array[] = $row['user_email'];
    $sub_array[] = $row['user_first_name'];
    $sub_array[] = $row['user_last_name'];
    $sub_array[] = $row['user_type']=="super_admin"?"Super Admin":"Employee";;
